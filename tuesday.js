...
2
3
can have many stars instead of just one of both start and end
star-slash ends a mutiline comment */

n = 12 //super chill
let x = 123; //more formal

i = 123 //interger (whole numbers)
f = 99.999 //fraction, float (floating point decimal)

num = 1.1 //just numbers

text = "123.45 words" //14 bytes? string of characters - data type string
